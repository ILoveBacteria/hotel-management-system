		...
		{#if showForm}
			...
			>
				...
				>
					...
					<!-- Modal Body -->
					<div
						class="px-6 py-4 overflow-y-auto max-h-[calc(90vh-130px)]"
					>
						<form
						...
						{#each roomTypes as roomType}
							<tr>
								...
								<td
									class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400"
								>
									{roomType.double_beds} Double, {roomType.single_beds}
									Single
								</td>
								<td
			...
			>
				...
				>
					...
					<p class="text-gray-500 dark:text-gray-400 mb-4">
						Are you sure you want to delete {selectedRoomType?.name}?
