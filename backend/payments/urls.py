...
from payments.views import BillListView, BillDetailView, PayBillView, PaymentGatewayView
...
urlpatterns = [
    ...
    path('pay/<int:bill_id>/', PaymentGatewayView.as_view(), name='payment-gateway'),
]
